                ...
                <div class="navbar-collapse collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="dropdown09" data-bs-toggle="dropdown" aria-expanded="false">List Bots</a>
...
<li><a class="dropdown-item" href="activities.php">Activities</a></li>
        ...
        <div class="card text-center mx-auto mt-3 ms-1 me-1">
            <div class="card-body">
                <div class="hstack me-2">
                    <a href="create_bot.php" class="card-link bg-light ms-auto border"><span class="mb-0 btn btn-sm btn-outline-dark">Create</span></a>
                </div>
