...
<head>
    ...
    <title>Change password - Arecibo</title>
                ...
                <div class="navbar-collapse collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="dropdown09" data-bs-toggle="dropdown" aria-expanded="false">Change password</a>
...
<li><a class="dropdown-item" href="activities.php">Activities</a></li>
        ...
        <?php
        $error = isset($_GET['i']) ? $_GET['i'] : -1; // -1 = OK

        if (strcmp($error, "0") == 0) {
            echo '<p class="text-success text-center fs-5 fw-light">You have successfully change password</p>';
        }

        if (strcmp($error, "1") == 0) {
            echo '<p class="text-danger text-center fs-5 fw-light">Incorrect password!</p>';
        }
        ?>
            ...
            <div class="card-body">
                ...
                <form action="changep.php" method="post">
                    <div class="form-floating">
                        <input type="password" class="form-control mb-3" id="cpassword" name="cpassword" placeholder="Current password" autocomplete="off" required>
                    ...
                    <div class="form-floating">
                        <input type="password" class="form-control mb-3" id="rpassword" name="rpassword" placeholder="Confirm password" required>
                        <label for="rpassword">Confirm password</label>
                    </div>

                    <button class="btn btn-sm btn-dark" type="submit" value="submit" onclick="return Validate()">Change password</button>
                </form>
