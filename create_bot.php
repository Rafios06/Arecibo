...
<head>
    ...
    <title>Create Bot - Arecibo</title>
                ...
                <div class="navbar-collapse collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="dropdown09" data-bs-toggle="dropdown" aria-expanded="false">Create Bot</a>
...
<li><a class="dropdown-item" href="activities.php">Activities</a></li>
        ...
        <div class="card text-center mx-auto mt-5" style="width: 18rem;">
            ...
            ?>
                ...
                <h5 class="card-title">Create Bot</h5>

                <hr class="border-1 border-dark ms-2 me-2">

                <form action="cbot.php" method="POST" required>
                    <input class="form-control mb-3" type="text" placeholder="Username" name="botname" id="botname" maxlength="50" aria-label="Username" autocomplete="off">
                    <button class="btn btn-sm btn-outline-dark" type="submit" value="submit">Create</button>
                </form>
