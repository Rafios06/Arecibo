...
<li><a class="dropdown-item" href="activities.php">Activities</a></li>
        ...
        <div class="card text-center mx-auto mt-5" style="width: 18rem;">
            <div class="card-body">
                ...
                <?php
                if(isAdmin()){
                    echo '<h6 class="card-subtitle mb-3 text-muted">Admin</h6>';
                } else {
                    echo '<h6 class="card-subtitle mb-3 text-muted">User</h6>';
                }
                ?>
                <hr class="border-1 border-dark ms-2 me-2">
                <a href="<?php echo 'search.php?se=' . htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?>" class="card-link"><span class="btn btn-sm btn-outline-primary">All your posts</span></a>
                <a href="signout.php" class="card-link"><span class="btn btn-sm btn-outline-danger">Sign out</span></a>
            </div>
        </div>
    </div>
