    ...
    <div class="content">
                ...
                <div class="navbar-collapse collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="dropdown09" data-bs-toggle="dropdown" aria-expanded="false">Settings</a>
        ...
        <div class="card text-center mx-auto mt-5" style="width: 18rem;">
            <div class="card-body">
                ...
                <p class="mb-0 text-start fw-light">API Key</p>
                <p class="card-text border"><?php echo getApiKey($_SESSION['id']); ?></p>
                <a href="resetkey.php" class="card-link"><span class="btn btn-sm btn-outline-dark">Reset API Key</span></a></br>

                <hr class="border-1 border-dark ms-2 me-2">

                <a href="changepass.php" class="card-link"><span class="mb-0 btn btn-sm btn-outline-dark">Change password</span></a></br>

                <hr class="border-1 border-dark ms-2 me-2">

                <a href="delete_account.php" class="card-link"><span class="mb-0 btn btn-sm btn-danger">Delete your account</span></a></br>
