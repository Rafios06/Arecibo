...
<head>
    ...
    <title>Activities - Arecibo</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Navigation bar">
            <div class="container-fluid">
                <a class="navbar-brand" href="activities.php">
                    <img class="bi mb-2" alt="Arecibo" loading="lazy" style="width: auto; height: auto;" src="assets/static_pages/arecibo_logo.svg">
                </a>
                ...
                <div class="navbar-collapse collapse" id="navbarsExample09">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="dropdown09" data-bs-toggle="dropdown" aria-expanded="false">Activities</a>
...
<li><a class="dropdown-item" href="activities.php">Activities</a></li>
        ...
        <div class="container-fluid mt-1">
            ...
            if ($stmt = $con->prepare('SELECT * FROM posts WHERE id ORDER BY time_reception DESC LIMIT ' . $signals_per_page . ' OFFSET ' . ($nb_page * $signals_per_page))) {
                $stmt->execute();
                $stmt->store_result();
            ...
            <p class="text-start mb-1" style="text-overflow: ellipsis; max-width: 64rem; overflow: hidden; white-space: nowrap;">' .
        ...
        <hr class="border-1 border-dark ms-2 me-2">';
                ...
                if ($num_show <= 0 && $nb_page > 0 || $nb_page < 0) {
                    header('Location: activities.php?page=0');
                }
            } else {
                echo 'error';
            }
        ...
        <nav aria-label="Page navigation" class="mx-auto" style="width: 250px;">
            <ul class="pagination">
                ...
                if ($nb_page <= 0 && $num_show >= 0) {
                    $nb_page = 0;
                    echo '<li class="page-item disabled"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page - 1) . '">Previous</a></li>
                    <li class="page-item"><a class="page-link text-dark fw-bold" href="activities.php?page=' . $nb_page . '">' . $nb_page . '</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page + 1) . '">' . ($nb_page + 1) . '</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page + 2) . '">' . ($nb_page + 2) . '</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page + 1) . '">Next</a></li>';
                } else {
                    echo '<li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page - 1) . '">Previous</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page - 1) . '">' . ($nb_page - 1) . '</a></li>
                    <li class="page-item"><a class="page-link text-dark fw-bold" href="activities.php?page=' . $nb_page . '">' . $nb_page . '</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page + 1) . '">' . ($nb_page + 1) . '</a></li>
                    <li class="page-item"><a class="page-link text-dark" href="activities.php?page=' . ($nb_page + 1) . '">Next</a></li>';
